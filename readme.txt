Уважаемые кандидаты, чтобы быстрее рассмотреть Вашу кандидатуру на вакансию, предлагаем ответить на вопрос:

Перед встречей с руководителем необходимо будет выполнить тестовое задание (условия ниже).

Просьба ответить - сможете ли Вы его выполнить? 
